 ...
 */
console.log()
const messagePrefix = chalk['bold']['cyan'](`[${Object.getOwnPropertyNames(packageJson.bin)[0]}]`)
const errorPrefix = chalk['bold']['red'](`[${Object.getOwnPropertyNames(packageJson.bin)[0]}]`)
