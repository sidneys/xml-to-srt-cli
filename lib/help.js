...
let print = () => {
    ...
    console.log(formatTableRow(`${chalk['bold'](Object.keys(packageJson['bin'])[0])}  ${chalk['underline']('file[.xml]')}`))

    console.log(formatTextHeader('options'))

    console.log(formatTableRow(`${chalk['bold']('file')}`, `XML Subtitle file`))
